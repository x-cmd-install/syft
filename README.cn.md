...
![syft](https://repo.x-cmd.io/syft.svg?lang=zh)
...
合计: **793,853** 行代码（覆盖前 5 种语言、共 **1609** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Json | 577,396 | 0 | 4 | 253 |
| Go | 175,332 | 13,530 | 20,856 | 1198 |
...
- **上游仓库**: <https://github.com/anchore/syft>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v1.51.1` (2026-08-27)
- **最近提交**: 2026-09-11
- **Release 含资产**: 31 个

## 流行度

- **Star**: 9,553 · **Fork**: 952 · **开放 issue**: 1,582 · **贡献者**: 269

## 累计统计

- **发布数**: 241 · **已合并 PR**: 3116 · **开放 PR**: 138 · **已关闭 issue**: 1076 · **开放 issue**: 506 · **提交数**: 3539

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 1 | 48 | 39 | 2 | 12 | 60 |
| last60d | 2026-07-14 | 5 | 106 | 62 | 14 | 24 | 113 |
| 90d | 2026-06-14 | 6 | 154 | 72 | 24 | 37 | 181 |
| last180d | 2026-03-16 | 12 | 283 | 99 | 59 | 59 | 295 |
| 360d | 2025-09-17 | 27 | 561 | 110 | 121 | 95 | 570 |
| last720d | 2024-09-22 | 56 | 1174 | 134 | 230 | 230 | 1187 |
...
在 [repology.org](https://repology.org/project/syft) 上共有 **83** 个发行版报告此项目。**4** 个 ✅ 已是最新上游版本，**63** 个 ⚠️ 使用旧版本。
...
syft 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `syft` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/syft.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T05:11:34Z._
